...
<div class="container py-2">
    ...
    if (isset($_POST['modifier'])) {
        ...
        if (!empty($libelle) && !empty($prix) && !empty($categorie)) {
            ...
            if (!empty($filename)) {
                ...
                $updated = $sqlState->execute([$libelle, $prix, $discount, $categorie, $description,$quantite,$filename, $id]);
            } else {
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <input type="number" class="form-control" value="<?= $produit->quantité ?>" name="quantite" id="quantite" max="100" min="0">
        ...
        <select name="categorie" class="form-control">
            ...
            foreach ($categories as $categorie) {
                ...
                echo "<option $selected value='" . $categorie['id'] . "'>" . $categorie['titre'] . "</option>";
            }
            ?>
        </select>
