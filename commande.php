...
$idCommande = $_GET['id'];
$sqlState = $pdo->prepare('SELECT commande.*,utilisateurs.login as "login" FROM commande 
...
<div class="container py-2">
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
        <?php
        $sqlStateLigneCommandes = $pdo->prepare('SELECT ligne_commande.*,produits.nom,produits.image from ligne_commande
    ...
    <table class="table table-striped table-hover">
        ...
        <?php foreach ($lignesCommandes as $lignesCommande) : ?>
            <tr>
                ...
                <td><?php echo $lignesCommande->nom ?></td>
                <td><?php echo $lignesCommande->prix ?> <i class="fa fa-solid fa-dollar"></i></td>
                <td>x <?php echo $lignesCommande->quantité ?></td>
