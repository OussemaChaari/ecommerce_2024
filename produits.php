...
<div class="container py-2">
    ...
    <table class="table table-striped table-hover">
        ...
        $categories = $pdo->query("SELECT produits.*,categories.titre as 'categorie_libelle' FROM produits INNER JOIN categories ON produits.id_categorie = categories.id")->fetchAll(PDO::FETCH_OBJ);
        foreach ($categories as $produit){
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger" href="supprimer_produit.php?id=<?php echo $produit->id ?>" onclick="return confirm('Voulez vous vraiment supprimer le produit <?php echo $produit->nom?> ?')">Supprimer</a>
                </td>
            </tr>
            <?php
        }
